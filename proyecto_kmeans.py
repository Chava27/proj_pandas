...
df = pd.DataFrame(tablaMonterrey, columns = ['cantidad_invitados',tablaMes2_mty])

print(df)
plt.scatter (df['cantidad_invitados'], tablaMes2_mty)
plt.show()
...
plt.scatter(df['cantidad_invitados'],tablaMes2_mty, c=kmeans.labels_.astype(float),s=50,alpha=0.5)
